...
caminho1 = Path('modulos')      # O objeto caminho1, do módulo Path, faz referência ao repositório modulos (HelloWorld).
...
print(caminho2.glob('*.py'))            # O método retorna um Generator Object (assunto avançado).
