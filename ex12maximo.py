...
# Colocar esta função (achar_max) em um módulo separado (utilidades) e chamá-la neste módulo (25.a.maximo)

from modulos.utilidades import achar_max

numeros = [25, 4, 54, 34, 78, 16]
# Se trocassemos as linhas 10 e 11 de lugar, a chamada do max(numeros) padrão do Python não funcionaria mais.
# o max da linha 10 está roxo, pois se refere a uma função built-in do Python.
print(max(numeros))
...
# Neste caso, estaríamos sobrescrevendo a função padrão (o que não é legal).
